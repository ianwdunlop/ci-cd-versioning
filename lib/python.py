...
def config_pip():
    ...
    call(["pip", "config", "set", "global.index", f"https://{nexus_username}:{nexus_password}@{nexus_host}/{index_path}"])
    call(["pip", "config", "set", "global.index-url", f"https://{nexus_username}:{nexus_password}@{nexus_host}/{index_url_path}"])
